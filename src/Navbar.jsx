...
const Navbar = () => {
  return (
    <>
      <header className="navbar container-fluid  bg-white  navbar-expand  shadow-lg  bg-white  ">
       ...
       <HiOutlineMenuAlt2 />
        ...
        <div className="input d-flex col-6 col-sm-7 ">
          ...
          <input type="text"placeholder="Search the Product"className=" rounded-end-4 w-100 w-sm-50 w-lg-25"/>
        </div>
